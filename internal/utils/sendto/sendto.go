...
const (
	...
	SMTPPort     = "587"
	SMTPUsername = "kietchu972@gmail.com"
	SMTPPassword = "naog tdac yaer wboq"
)
...
func SendTextEmailOtp(to []string, from string, otp string) error {
	...
	if err != nil {
		global.Logger.Error("Email sending failed::", zap.Error(err))
		return err
	}
...
func SendTemplateEmailOtp(
	to []string, from string, nameTemplate string, dataTemplate map[string]interface{},
) error {
